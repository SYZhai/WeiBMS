<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeIndex.aspx.cs" Inherits="BPMS.WEB.CommonModule.Employee.EmployeeIndex" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#target_right").attr("src", "EmployeeList.aspx");
        })
    </script>
</head>
<body>
