<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExceptionIndex.aspx.cs" Inherits="BPMS.WEB.CommonModule.ExceptionLog.ExceptionIndex" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            iframeresize();
            Loading(true);
            $("#target_left").attr("src", "ExceptionFile.aspx");
            $("#target_right").attr("src", "ExceptionText.aspx");
        })
    </script>
</head>
<body>
    <form id="form1" runat="server">
        <div id="iframeMainContent">
            <div class="iframeleft" style="width: 250px;">
