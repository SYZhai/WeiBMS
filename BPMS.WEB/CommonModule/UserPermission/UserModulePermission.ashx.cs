...
{
    /// <summary>
    /// UserModulePermission1 的摘要说明
    /// </summary>
    public class UserModulePermission1 : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            switch (active)
            {
                case "AddModulePermission"://分配用户权限
                    ...
                    context.Response.Write(bpms_usermenuibll.AddModulePermission(array, UserId, CreateUserId, CreateUserName));
