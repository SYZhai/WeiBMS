<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlexibleFormIndex.aspx.cs" Inherits="BPMS.WEB.CommonModule.FlexibleForm.FlexibleFormIndex" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            iframeresize();
            Loading(true);
            $("#target_left").attr("src", "FlexibleFormType.aspx");
        })
    </script>
</head>
<body>
