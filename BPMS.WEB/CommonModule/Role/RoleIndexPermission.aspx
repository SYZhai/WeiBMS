<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleIndexPermission.aspx.cs" Inherits="BPMS.WEB.CommonModule.Role.RoleIndexPermission" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            iframeresize();
            Loading(true);
            $("#target_left").attr("src", "CompanyTreePermission.aspx");
        })
    </script>
</head>
<body>
