<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyTree.aspx.cs" Inherits="BPMS.WEB.CommonModule.Role.CompanyTree" %>
...
<head runat="server">
    ...
    <script>
        ...
        function GetClickValue() {
            ...
            var path = 'RoleList.aspx?OrganizationId=' + OrganizationId + '&FullName=' + escape(FullName);
