<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DictionaryIndex.aspx.cs" Inherits="BPMS.WEB.CommonModule.Dictionary.DictionaryIndex" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            iframeresize();
            Loading(true);
            $("#target_left").attr("src", "ItemsList.aspx");
            $("#target_right").attr("src", "ItemDetailsList.aspx");
        })
    </script>
</head>
<body>
