...
namespace BPMS.IBusiness
{
    ...
    /// </author>
    /// </summary>
    public interface BPMS_TableColumnsIBLL
    {
        #region Method
        /// <summary>
        /// 获取最大编号
        ...
        /// <returns></returns>
        bool Insert(BPMS_TableColumns entity);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        /// <param name="entity">实体类</param>
        /// <returns></returns>
        bool Update(BPMS_TableColumns entity);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        ...
        /// <param name="KeyValue">主键</param>
        /// <returns></returns>
        BPMS_TableColumns GetEntity(string KeyValue);
        /// <summary>
        /// 获得数据列表
        /// </summary>
