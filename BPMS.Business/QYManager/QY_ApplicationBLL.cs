...
namespace BPMS.Business
{
    ...
    /// </author>
    /// </summary>
    public class QY_ApplicationBLL : QY_ApplicationIBLL
    {
        private readonly QY_ApplicationDAL dal = new QY_ApplicationDAL();
        ...
        /// <returns></returns>
        public bool Insert(QY_Application entity)
        {
        ...
        /// <param name="entity">实体类</param>
        /// <returns></returns>
        public bool Update(QY_Application entity)
        {
