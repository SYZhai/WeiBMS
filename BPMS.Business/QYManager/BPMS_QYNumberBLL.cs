...
namespace BPMS.Business
{
    ...
    /// </author>
    /// </summary>
    public class BPMS_QYNumberBLL : BPMS_QYNumberIBLL
    {
        private readonly BPMS_QYNumberDAL dal = new BPMS_QYNumberDAL();
        ...
        /// <returns></returns>
        public bool Insert(BPMS_QYNumber entity)
        {
        ...
        /// <param name="entity">实体类</param>
        /// <returns></returns>
        public bool Update(BPMS_QYNumber entity)
        {
