...
var imagesPath = "/Themes/Scripts/niceforms/img/";
...
function niceform(nf) {
    nf._inputText = new Array(); nf._inputRadio = new Array(); nf._inputCheck = new Array(); nf._inputFile = new Array(); nf._textarea = new Array(); nf._select = new Array(); nf._multiselect = new Array();
...
function inputCheck(el) { //extend Checkboxes
    ...
    if (el.checked) {
        el.dummy.className = "NFCheckOk";
    }
    else {
        el.dummy.className = "NFCheck";
    }
    el.dummy.ref = el;
    if (isIE == false) { el.dummy.style.left = findPosX(el) + 'px'; el.dummy.style.top = findPosY(el) - 1 + 'px'; }
    else { el.dummy.style.left = findPosX(el) + 'px'; el.dummy.style.top = findPosY(el) - 1 + 'px'; }
    el.dummy.onclick = function () {
        if (!this.ref.checked) {
            this.ref.checked = true;
            this.className = "NFCheckOk";
        }
        else {
    ...
    el.onclick = function () {
        if (this.checked) {
            this.dummy.className = "NFCheckOk";
        }
        else {
...
function selects(el) { //extend Selects
    ...
    el.dummy.style.top = findPosY(el) - 3 + 'px';
