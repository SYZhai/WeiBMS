<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="BPMS.CodeMatic.ErrorPage.Error" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="not-support-browser">
            <div class="not-support-browser-contant">
                <div style="text-align:center;"><h1 style="font-size: 44px">您所访问的页面无法显示</h1></div>
                <p>
